            ...
            <div className="column is-6">
              ...
              <div className="bg-gray-600 bg-opacity-55 rounded-lg mb-5">
                ...
                <p className="text-white font-bold has-text-justified text-2xl pl-5 pr-5 pb-5">
                   ...
                   <li className="mb-2">Demonstrated proficiency in Figma, Node.js, React, PostgreSQL, web development, and platform integration while enhancing problem-solving and analytical abilities.</li>
                </p>
              </div>
              ...
              <div className="bg-gray-600 bg-opacity-55 rounded-lg mb-5">
                ...
                <p className="text-white font-bold has-text-justified text-2xl pl-5 pr-5 pb-5">
                    ...
                    <li className="mb-2">Engineered a device integrating LoRa technology to send fire alerts in areas without internet connectivity.</li>
                </p>
              </div>
